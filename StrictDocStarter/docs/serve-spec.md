...
│   └── sovd-automotive/                 # 初期 default、 ASIL/Layer/Type custom fields、 SOVD 教材
...
│       ├── 05-notation-rst.sdoc         # (D-9/S-1) RST 記法デモ: Mermaid(raw html)/数式/画像
│       ├── 06-notation-markdown.sdoc    # (D-9/S-1) Markdown 記法デモ: 表/コード/画像/Mermaidフェンス
